...
<body>
   <div id="wrap" align="center">
      <h1>게시글 수정</h1>
      <form name="frm" method="post" action="modyAction" encType="multipart/form-data">
      <!-- enc타입을 적어줘야만 첨부파일이 서버로 전송된다. -->
         <table id="list">
            <tr>
               <th>작성자</th>
               <td><input type="text" name="name" value=${bvo.name } readonly> * 필수
            ...
            <tr>
               <th>비밀번호</th>
               <td><input type="password" name="pass" value=${bvo.pass }> * 필수 (게시물 수정
                  삭제시 필요합니다.)</td>
            </tr>
            <tr>
               <th>이메일</th>
            ...
            <tr>
               <th>제목</th>
               <td><input type="text" size="70" name="title" value=${bvo.title }> * 필수</td>
            </tr>
            <tr>
               <th>내용</th>
               <td><textarea cols="70" rows="15" name="content" >${bvo.content }</textarea></td>
            </tr>
            <tr>
               <th>첨부파일1</th>
